create or replace function USR_F_WOAS_GET_GS_SALE
/*
Раздел Акты списания недостач/оприходования излишков (спецификация)
Функция для колонки "#К продаже"
07/11/2024 Степанов М.
grant execute on USR_F_WOAS_GET_GS_SALE to public;
*/
(
 nCOMPANY       in number
