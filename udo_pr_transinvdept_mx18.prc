create or replace procedure UDO_PR_TRANSINVDEPT_MX18
(
  ...
  begin
    ...
    select trim(t.pref), trim(t.numb), t.docdate,
           st1.azs_name, t.mol,
           st2.azs_name, t.in_mol,
           UDO_F_FACEACC_GET_SHEFR(t.faceacc),
           f.numb
...
--        PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_SERNUMB, sSERNUMB_STR);
    ...
    for spec in (
        ...
        /* Наименование */
        PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_SPEC_NAME,    0, nLINE, spec.sModifName);
        /* Заводской номер */
        PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_SPEC_SERNUMB, 0, nLINE, spec.sarticle);
        /* Единица измерения*/
    ...
    PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_MOL_OUT_PERS, sPERSON );
    PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_MOL_OUT_POST, sPOST );
    -- Получил
    SIGNER_ATTR(nMOL_IN, dDOC_DATE, sPERSON, sPOST);
    PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_MOL_IN_PERS, sPERSON );
    PRSG_EXCEL.CELL_VALUE_WRITE( sCELL_MOL_IN_POST, sPOST );
