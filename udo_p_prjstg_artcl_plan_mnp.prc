create or replace procedure UDO_P_PRJSTG_ARTCL_PLAN_MNP
/*
   ‘ормирование плановых показателей по стать€м (помес€чно)
...
begin
  ...
  FIND_FINSTATE_CODE(0,NCOMPANY, UDO_F_SYS0006_GET_CONST_VAL(NCOMPANY, '—ќ—“_ѕЋјЌ'), NFINSTATE);
...
end UDO_P_PRJSTG_ARTCL_PLAN_MNP;
/*
   create public synonym UDO_P_PRJSTG_ARTCL_PLAN_MNP for UDO_P_PRJSTG_ARTCL_PLAN_MNP;
   grant execute on UDO_P_PRJSTG_ARTCL_PLAN_MNP to public;
  */
/
