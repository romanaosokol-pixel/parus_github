create or replace procedure UDO_P_STRPLRESJRNL_MINS_IFD
  (
...
end UDO_P_STRPLRESJRNL_MINS_IFD;
-- grant execute on UDO_P_STRPLRESJRNL_MINS_IFD to public;
/
