create or replace procedure UDO_P_MODUL_INVENT
(
...
is
begin
  UDO_PKG_MODUL_INVENT.START_IN_MAKE(NCOMPANY    =>NCOMPANY,
                                     NPROCESS    =>NPROCESS,
                                     SCRN        =>SCRN,
                                     sJUR_PERS   =>sJUR_PERS,
                                     sDOCTYPE    =>sDOCTYPE,
...
end UDO_P_MODUL_INVENT;
--grant execute on UDO_P_MODUL_INVENT to public;
/
