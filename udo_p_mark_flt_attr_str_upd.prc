create or replace procedure UDO_P_MARK_FLT_ATTR_STR_UPD
/*
   Клиентское исправление атрибута типа "Строка" в разделе "Фильтры показателей (атрибуты)"
  */
(
...
begin
  ...
  PKG_ENV.PROLOGUE(NCOMPANY  => PREC.COMPANY
                  ...
                  ,NDOCUMENT => REC.RN);
  --базово исправим
  UDO_PKG_MARK_FLT.MARK_FLT_ATTR_STR_UPDATE(NRN             => NRN
...
--grant execute on UDO_P_MARK_FLT_ATTR_STR_UPD to public;
/
